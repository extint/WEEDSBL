...
# Path to your CSV
CSV_PATH = "/home/vjtiadmin/Desktop/BTechGroup/WEEDSBL/scripts/sota/dataset_utils/mask_class_percentages.csv"

# Output text file
OUTPUT_PATH = "/home/vjtiadmin/Desktop/BTechGroup/WEEDSBL/scripts/sota/dataset_utils/aug_mixed_images.txt"
...
def main():
    ...
    top_400_weed = df_sorted.head(400)
    ...
    top_80_crop = df_crop_sorted.head(80)
    
    # Combine both datasets
    new_df = pd.concat([top_400_weed, top_80_crop])
    ...
    print(f"  - {len(top_400_weed)} images with highest weed percentage")
    print(f"  - {len(top_80_crop)} images with highest crop percentage (0% weed)")
